        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                ki7.sendText(msg.to,kimid)
            elif "Pb8 mid" == msg.text:
                ki8.sendText(msg.to,ki2mid)
            elif "Pb9 mid" == msg.text:
                ki9.sendText(msg.to,kimid)
                ...
                ki8.sendText(msg.to,ki6mid)
                ki9.sendText(msg.to,ki6mid)
            elif "TL:" in msg.text:
...
#---------------------------------------------------------
            elif msg.text in ["Bot Like", "Bot like"]: #Semua Bot Ngelike Status Admin
                 if msg.from_ in admin:
            ...
            elif msg.text in ["Like Temen", "Bot like temen"]: #Semua BOt Ngelike Status Temen
                if msg.from_ in admin:
                    print "[Command]Like executed"
                    cl.sendText(msg.to,"Kami siap Like status teman boss")
                    cl.sendText(msg.to,"Kami siap Like status Admin")
                    try:
                      autolike()
                    except:
                      pass
...
#---------------------------------------------------------
                ...
                if wait["contact"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already open 􀜁􀇔?")
                ...
                if wait["protect"] == True:
                    ...
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already ON􀜁􀇔?")
                    else:
                ...
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ini sudah off 􀜁􀇔?👈")
                    else:
                        cl.sendText(msg.to,"Hal ini sudah terbuka ô€¨ 👈")
                else:
                    wait["autoJoin"] = True
              ...
              if msg.from_ in admin:
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"on👈􀜁􀇔?")
                    else:
                        cl.sendText(msg.to,"Sudah terbuka 􀜁􀇔?")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done👈􀜁􀇔?")
                    else:
                        cl.sendText(msg.to,"Is already open👈􀜁􀇔?")
            elif msg.text in ["Auto leave off","Auto leave: off"]:
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"on👈􀜁􀇔?")
                    else:
                        cl.sendText(msg.to,"Sudah off👈􀜁􀇔?")
                else:
                ...
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already turned off 􀜁􀇔?👈")
                else:
                    wait["timeline"] = False
                    if wait["lang"] == "JP":
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': Creator}
                cl.sendText(msg.to,"􀜁􀇔? My Creator 􀜁􀇔? ")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀜁􀇔? Dont Kick out From group 􀜁􀇔? ")
...
#                        try:
#                            admin.append(target)
#                            cl.sendText(msg.to,"Staff Baru Ditambahkan")
#                        except:
#                            pass
...
#                        try:
#                            admin.remove(target)
#                            cl.sendText(msg.to,"Staff Lama Dihapus")
#                        except:
#                            pass
...
#-----------------------------------------------------------
            elif msg.text in ["Woy","woy","Woi","Halo","ipey","Bot"]:
                   quote = ['Istri yang baik itu istri yang Mengijinkan Suaminya poligami.','ah kupret lu','ada orang disni?',' kenapa panggil2 kangen ya','ada janda nganggur ga?','muka lu kaya jamban','Orang ganteng di panggil terus','LU kangen gw','Manggil mulu so kecakepan']
...
#-----------------------------------------------------------
                   ...
                   for target in targets:
                       try:
                           ...
                           cl.sendText(msg.to,"✯Bakekok✯Limit✯")
                   ...
                   cl.sendText(msg.to,"Mid:" +  key1)
                       ...
                       for s in gs.members:
                           if _name in s.displayName:
                              targets.append(s.mid)
                       if targets == []:
                           sendMessage(msg.to,"✯Tidak✯Ada✯User✯Bakekok✯")
                           pass
                       else:
                           for target in targets:
                                try:
                                    ...
                                    cl.sendText(msg.to,"✯Bakekok✯Mah✯")
...
#-----------------------------------------------------------
                ...
                if msg.from_ in admsa:
                  wait["blacklist"] = {}
                  cl.sendText(msg.to,"✯Banned✯Bakekok✯Berish���")
#-----------------------------------------------------------

            elif "Spam change: " in msg.text:
                wait["spam"] = msg.text.replace("Spam change: ","")
                cl.sendText(msg.to,"Spam Telah Diganti")

            elif "Spam:add:" in msg.text:
                wait["spam"] = msg.text.replace("Spam:add:","")
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Spam Di Tambahkan")
                else:
                    cl.sendText(msg.to,"Done")
...
#------------------------------------------------------------
            elif msg.text in ["Absen","Absen bot","Respon"]:
              if msg.from_ in admin:
#                cl.sendText(msg.to,"admin")
                ki.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki2.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯'")
                ki3.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki4.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki5.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki6.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki7.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki8.sendText(msg.to,"🔜ąʍ¥ ţ€ąʍ β๏ţ🔙☯")
                ki.sendText(msg.to,"Semua hadir boss\nsiap menunggu perintah anda Protect Group\nDan Crooottt..!!!")
#-----------------------------------------------------<------
...
#------------------------------------------------------------------
 ...
 #------------------------------------------------------------------
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                ...
                                ki.sendText(msg,to,"Group Cʳᵒᵗ")
                                ki2.sendText(msg,to,"Group Cʳᵒᵗ")
            ...
            elif msg.text in ["Maaaangat","Burrammmmmm"]:
                if msg.toType == 2:
                    group = cl.getGroup(msg.to)
                    gMembMids = [contact.mid for contact in group.invitee]
                    for _mid in gMembMids:
...
#                cl.sendText(msg.to,(bctxt))
                ...
                ki.sendText(msg.to,"Pong 􀜁􀇔?")
                ki2.sendText(msg.to,"Pong 􀜁􀇔?")
                ki3.sendText(msg.to,"Pong 􀜁􀇔?")
                ki4.sendText(msg.to,"Pong 􀜁􀇔?")
                ki5.sendText(msg.to,"Pong 􀜁􀇔?")
                ki6.sendText(msg.to,"Pong 􀜁􀇔?")
                ki7.sendText(msg.to,"Pong 􀜁􀇔�")
                ki8.sendText(msg.to,"Pong 􀜁􀇔�")
                ki9.sendText(msg.to,"Pong 􀜁􀇔�")
#----------------------------------------------- 
#-----------------------------------------------
        if op.type == 19:
            try:
...
#------------------------------------------------------------------------------------
        if op.type == 17:
           ...
           cl.sendText(op.param1, cl.getContact(op.param2).displayName +  "Selamat Datang Di Grup  " + str(ginfo.name))
        ...
        if op.type == 15:
           if op.param2 in Bots:
              return
           cl.sendText(op.param1, "☯Innalilahi😜☯\n☯☯☯☯☯☯☯☯☯☯\n☯Pasti Baper Tuh Orang😜😜😜☯")
     ...
     for zx in range(0,50):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ~Amii~\n\nhttp://line.me/ti/p/~amiiqila_")
            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ~Amii~\n\nhttp://line.me/ti/p/~amiiqila_")
            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ~Amii~\n\nhttp://line.me/ti/p/~amiiqila_")
            ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ~Amii~\n\nhttp://line.me/ti/p/~amiiqila_")
            print "Like"
            print "Like"
            print "Like"
          except:
